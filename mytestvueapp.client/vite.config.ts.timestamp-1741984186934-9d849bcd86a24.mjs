...
var __vite_injected_original_import_meta_url = "file:///C:/Users/helmrickj9306/source/repos/Pixel-Painter-2.0/mytestvueapp.client/vite.config.ts";
...
var target = env.ASPNETCORE_HTTPS_PORT ? `https://localhost:${env.ASPNETCORE_HTTPS_PORT}` : env.ASPNETCORE_URLS ? env.ASPNETCORE_URLS.split(";")[0] : "https://localhost:7154";
